...
> **Leads → Kunden** ✅ · **Events → Meeting-interactions** ✅ · **Cases → Tickets** ✅ · **OpportunityLineItems → Quote** ✅ · **Notes → Note-interactions** ✅ (`salesforce://note/<id>`, ParentId-Link).
> **Noch offen für vollständige Migration:** Attachments,
